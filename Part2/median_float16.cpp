...
float_t getMedian_float_t(float_t currArray[], int arraySize)
{
    int i,j;
    float_t tmp;
...
void testFunction_float_t()
{
    ...
    printf("\n");
    int arraySize = sizeof(testArray) / sizeof(float_t);

    float_t returnValue = getMedian_float_t(testArray, arraySize);
